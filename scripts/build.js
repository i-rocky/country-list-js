...
const politicalDivisions = readJson('reference/political-divisions.json');
...
fs.writeFileSync(path.join(root, 'src', 'generated.ts'),
    '// Generated by scripts/build.js from countries/ and reference/.\n' +
...
console.log('built %d files from %d countries, and src/generated.ts',
