...
import country, { findByIso2, findByName, names, all, cache, ls } from 'country-list-js';
...
ok('default export has 13 members', Object.keys(country).length === 13);
